var AllNetPlugins = (() => {
  ...
  // src/capacitor-core-shim.js
  var Capacitor, registerPlugin, WebPlugin;
  var init_capacitor_core_shim = __esm({
    "src/capacitor-core-shim.js"() {
      Capacitor = window.Capacitor;
      registerPlugin = window.Capacitor ? window.Capacitor.registerPlugin : function() {
      };
      WebPlugin = class {
      };
    }
  ...
  var init_base = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/base.js"() {
      init_capacitor_core_shim();
      BaseSocialLogin = class extends WebPlugin {
        constructor() {
          super();
        }
        parseJwt(token) {
  ...
  var AppleSocialLogin;
  var init_apple_provider = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/apple-provider.js"() {
      init_base();
      AppleSocialLogin = class extends BaseSocialLogin {
        constructor() {
          super(...arguments);
          this.clientId = null;
  ...
  var FacebookSocialLogin;
  var init_facebook_provider = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/facebook-provider.js"() {
      init_base();
      FacebookSocialLogin = class extends BaseSocialLogin {
        constructor() {
          super(...arguments);
          this.appId = null;
          this.scriptLoaded = false;
  ...
  var GoogleSocialLogin;
  var init_google_provider = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/google-provider.js"() {
      init_base();
      GoogleSocialLogin = class extends BaseSocialLogin {
        constructor() {
          super(...arguments);
          this.clientId = null;
  ...
  // node_modules/@capgo/capacitor-social-login/dist/esm/oauth2-provider.js
  var OAuth2SocialLogin;
  var init_oauth2_provider = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/oauth2-provider.js"() {
      init_tslib_es6();
      init_base();
      OAuth2SocialLogin = class extends BaseSocialLogin {
        constructor() {
          super(...arguments);
  ...
  // node_modules/@capgo/capacitor-social-login/dist/esm/twitter-provider.js
  var TwitterSocialLogin;
  var init_twitter_provider = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/twitter-provider.js"() {
      init_tslib_es6();
      init_base();
      TwitterSocialLogin = class extends BaseSocialLogin {
        constructor() {
          super(...arguments);
          this.clientId = null;
          this.redirectUrl = null;
  ...
  var init_web = __esm({
    "node_modules/@capgo/capacitor-social-login/dist/esm/web.js"() {
      init_capacitor_core_shim();
      init_apple_provider();
      init_facebook_provider();
      init_google_provider();
      init_oauth2_provider();
      init_twitter_provider();
      SocialLoginWeb = class _SocialLoginWeb extends WebPlugin {
        constructor() {
          super();
          ...
          const hasPending = !!localStorage.getItem(_SocialLoginWeb.OAUTH_STATE_KEY);
          const isPopup = !!window.opener || _SocialLoginWeb.POPUP_WINDOW_NAMES.has(window.name);
        ...
        async parseRedirectResult() {
          ...
          const stateRaw = localStorage.getItem(_SocialLoginWeb.OAUTH_STATE_KEY);
          let provider = null;
          let state;
          let nonce;
          if (stateRaw) {
      ...
      SocialLoginWeb.POPUP_WINDOW_NAMES = /* @__PURE__ */ new Set(["OAuth2Login", "XLogin", "Google Sign In", "Authorization"]);
    }
  });

  // node_modules/@capgo/capacitor-social-login/dist/esm/social-login.js
  init_capacitor_core_shim();
  var SocialLoginBase = registerPlugin("SocialLogin", {
    web: () => Promise.resolve().then(() => (init_web(), web_exports)).then((m) => new m.SocialLoginWeb())
  });

  // node_modules/@capgo/capacitor-social-login/dist/esm/auth-connect.js
  init_tslib_es6();
  var AUTH_CONNECT_PROVIDERS = ["auth0", "azure", "cognito", "okta", "onelogin"];
  var DEFAULT_SCOPES = {
  ...
  // src/capacitor-plugins.js
  window.AllNetSocialLogin = SocialLoginBase;
